...
async function fetchAndParseCharacters() {
  try {
    const response = await fetch("https://bluearchive.wikiru.jp/?%E3%82%AD%E3%83%A3%E3%83%A9%E3%82%AF%E3%82%BF%E3%83%BC%E4%B8%80%E8%A6%A7");
    ...
    if (characters.length > 0) {
      ...
      console.log(`Successfully fetched ${characters.length} characters from Wiki.`);
    }
